  ...
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSupports=true">
      <div class="discounts-left">
        <div class="activity" :class="suppportClasses[info.supports[0].type]">
          <span class="content-tag">
      ...
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" v-for="(support, index) in info.supports"
              :key="index" :class="suppportClasses[support.type]">
            <span class="content-tag">
  ...
  export default {
    data(){
      return{
        ...
        suppportClasses: ['activity-green', 'activity-red', 'activity-orange']
